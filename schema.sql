...
CREATE TABLE IF NOT EXISTS `moth` (
  ...
  `html_name` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT 'The HTML name that should be used for this moth, used when moth data is exported to an HTML page.  Leave this as NULL if the correct HTML name is just common_name with underscores replacing the spaces.',
